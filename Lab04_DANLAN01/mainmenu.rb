...
class MainMenu < Menu
    ...
    public
    def initialize(rentables, pricelist, economy, list_menu, economy_menu, statistics_menu)
        checking_in = MenuAlternative.new do
            checking_in(rentables, pricelist, economy)
        end
        ...
        list_action = MenuAlternative.new do
            sub_menu list_menu
        end
        ...
        statistics_action = MenuAlternative.new do
            sub_menu statistics_menu
        end
    ...
    private
    # helper method
    def check_in(rentables, type, pricelist, economy)
        ...
        if rentable == nil 
            ...
            rentable.check_in(type, pricelist, economy)
        end
    end
    
    def checking_in(rentables, pricelist, economy)
        ...
        check_in(rentables, type, pricelist, economy)
    end
